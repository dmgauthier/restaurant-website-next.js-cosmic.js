...
export async function Footer() {
  ...
  return (
    <div className="my-10 flex justify-center">
      <div className="inline-block backdrop-blur-sm pt-4 w-2/3">
        ...
        <div className="flex gap-x-8 justify-center">
          <div>
            <a className="text-lg" href={`mailto:${settings.metadata.email}`}>
              Courriel
            </a>
          </div>
          <div>
            <a className="text-lg" href={`tel:${settings.metadata.phone}`}>
              Telephone
            </a>
          </div>
        </div>
